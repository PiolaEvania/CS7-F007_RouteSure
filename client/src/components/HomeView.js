...
const HomeView = () => {
    ...
    if (getUser) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          Cookies.remove('jwt');
          axios.post('https://api-route-sure-git-production-route-sure.vercel.app/api/logout', removeUser, { withCredentials: true })
            .then(() => {
  ...
  const submitDataLaporan = (e) => {
    ...
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      axios.post('https://api-route-sure-git-production-route-sure.vercel.app/api/laporan', formData, {
