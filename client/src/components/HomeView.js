    ...
    <div className="bg-white h-screen">
      <header className="flex flex-1 bg-darkCharcoal p-6 justify-center items-center sticky bottom-0">
        ...
        {userRole === '671b672b3981db347cfd7832' && (
          ...
          >
            <img
              src="https://img.icons8.com/?size=50&id=Yj5svDsC4jQA&format=png&color=D9D9D9"
        ...
        <h1 className="text-lightGray text-3xl font-bold text-center flex-1 flex justify-start">
          RouteSure
        </h1>
        ...
        <nav className="hidden sm:flex justify-center items-center">
          ...
          >
            <img
              src="https://img.icons8.com/?size=50&id=105512&format=png&color=D9D9D9"
        ...
        >
          <img
            src="https://img.icons8.com/?size=50&id=98929&format=png&color=D9D9D9"
            alt="Hamburger Menu"
            className="hover:bg-blueA hover:rounded-md"
          />
        </button>
      ...
      {mobileMenuOpen && (
        <nav className="flex flex-col items-center bg-darkCharcoal p-4 w-full sm:hidden">
          <ul className="flex flex-col decoration-transparent text-lightGray">
      ...
      <div className='flex flex-col md:flex-row sm:flex-col ml-3 mt-3 mb-6'>
        ...
        <section className="flex-1 bg-white">
          <div className="px-2 py-2 h-full flex items-center justify-center">
            <div className="p-4 border bg-lightCharcoal border-white rounded-md shadow-md w-full">
              ...
              <form className="mt-5" encType="multipart/form-data">
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative mt-2">
                      <input
                        ...
                        type="text"
                        className="mt-2 flex h-10 w-full rounded-md border border-gray-500 bg-white px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-darkCharcoal focus:ring-offset-1 text-darkCharcoal"
                        name="name"
                        value={name}
                  ...
                  <div>
                    <button
                      className="inline-flex w-full items-center justify-center border-gray-500 rounded-md bg-white px-3.5 py-2.5 font-bold leading-7 text-darkCharcoal hover:bg-slate-900 transition duration-150 ease-in-out hover:text-white"
                      type="submit"
      ...
      <footer className='flex bg-darkCharcoal p-4'>
