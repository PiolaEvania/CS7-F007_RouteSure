      ...
      <div className="resetPassword bg-darkCharcoal min-h-screen">
        <div className="w-full flex justify-center items-center flex-col self-center min-h-screen">
          <div className="min-w-[300px] md:min-w-[400px] lg:min-w-[600px] border border-lightGray h-[350px] bg-inherit rounded shadow p-[20px]">
            <h1 className="text-center text-lightGray pb-5 bg-inherit font-sans font-bold text-[1.25rem] md:text-[1.5rem] lg:text-[1.7rem]">Reset Password</h1>
            <form method='post'>
              <div>
                <label htmlFor="password" className="block text-sm/6 font-medium text-lightGray">Password</label>
              ...
              <div>
                <label htmlFor="confirmPassword" className="mt-2 block text-sm/6 font-medium text-lightGray">Confirm Password</label>
                <div className="relative mt-2">
              ...
              <div className="mt-2 justify-center text-center">
                <a href='/login' className="text-lightGray hover:underline">Login to RouteSure</a>
              </div>
              <div className='pt-7'>
