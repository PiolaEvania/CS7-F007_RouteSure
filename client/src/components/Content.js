        ...
        <div className="flex h-auto w-screen justify-center items-center relative">
            <div className="mt-[80px] z-[5] absolute p-10 md:p-20 text-left w-full">
                ...
                <p className="text-base md:text-xl lg:text-2xl mt-2 md:mt-4 lg:mt-8 text-white mb-2 md:mb-4 lg:mb-6">
                    ...
                    dalam melaporkan masalah pada infrastruktur publik.
                </p> 
                <button
                    class="inline-block w-[150px] text-sm font-bold mt-2 rounded-md px-2 py-2 md:w-[200px] md:text-base md:mt-4 md:py-2 md:px-4 lg:w-[300px] lg:px-6 lg:py-4 lg:text-xl  bg-sky-700 hover:bg-white hover:text-sky-700 focus:text-white focus:bg-sky-700 text-gray-50 shadow-lg leading-loose transition duration-200"
